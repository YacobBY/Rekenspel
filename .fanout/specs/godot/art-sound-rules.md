...
| `voordeuromlijst` | receptie, in the front edge @ 72,119, the middle of the pink rug (2026-09-24) | the front door as only its outline, open: two white posts (`#FBF7EE`) 1 × 38 and a lintel 28 × 2 over them, one deep, round a 26 × 38 opening, and the threshold `#C9A27E` on the floor between the posts — you look through it at the rug and the lobby. Replaces `voordeur` and `welkomsmat` in the room (both models remain) |
