...
| deur | **de lift** (eigenaar, 2026-09-24: "Ik wil de winkels op een andere etage ... net als Habbo Hotel"): de winkelstraat is de **eerste verdieping** (`Kamer.etage` 1, world.md §1.2) en heeft geen deur naar de receptie meer; de lift staat in de linkerwand (x, at 24, deurpunt (0, 30), binnen (8, 30)), waar tot die dag de deur naar de receptie zat. In de receptie is waar de winkeldeur zat (achterwand rechts van de balie, z/106) nu de achterdeur naar de tuin. Een rit van de receptie hierheen is één stap (`Rooms.pad("receptie", "winkels")` = 2 kamers) |
