...
| `kamer2` | Kamer 2 🛏️ | 114 × 114 | 58 | gang | dezelfde inrichting als kamer 1, tweede slaapkamer. |
| `keuken` | Keuken 🍪 | 120 × 114 | 56 | gang, tuin, wasserij | voerkast, koekjeszak en de voerkar: hier wordt het eten verdeeld. |
| `tuin` | Tuin 🌳 | 130 × 130 | — (erf, vast kader) | keuken, zwembad | het gazon áchter het hotel: links de achtergevel met de keukendeur (luifel, deurmat, keukenraam), achter het hek het zwembad met parasol en trapje, verder tobbe, hok, boom, bal, kist, plus een vrijgehouden vloerzone voor het hinkelpad (de souvenirkraam verhuisde op 2026-09-24 naar de winkels). |
...
| `winkels` | Winkels 🛍️ | 132 × 112 | 54 | receptie | de winkelstraat naast de lobby (2026-09-24, games-d.md): vier kraampjes met gestreepte luifels (hoeden, sjaals, schoenen en de souvenirkraam die uit de tuin kwam), de luxe winkel met een gouden pui en een glazen vitrine, en de paskamer met een grote spiegel; hier kopen de dieren kleding en rekent het kind prijzen en betalingen uit. |
...
**Nieuwe ruimtes (golf 3, ticket P1a).** Het zwembad hangt aan de tuin via een opening in het achterhek. Het bad staat als data op de ruimte (`Rooms.get('zwembad').bad` = x 18..134, z 12..44), zodat een spel er een baan van L meter lineair op afbeeldt; de twee wachtplekken staan er ook (`.dek.start` en `.dek.over`). De dieren dwalen alleen op het dek vóór het water — de dwaalplekken, de deur en beide dek-plekken liggen in dezelfde convexe strook, dus geen enkele wandeling kruist het bad. De wasserij ligt naast de keuken en is de kamer van de wasmandtoren (G4). De tuin houdt een kale vloerzone vrij (`Rooms.get('tuin').zones`): `hinkel` langs de achterrand vóór het hok (76 × 16, voor de stapstenen van G3). De zone `kraam` langs de rechterzijrand (22 × 32, voor de souvenirkraam van G5) verviel op 2026-09-24: de kraam is de vierde kraam van de winkelstraat (eigenaar: "De kraam in de tuin voelt nu dubbelop die kan verwerkt worden in de winkels").
...
- Gast arriveert als het kind op de bel tikt (nooit automatisch, geen oplopende wachtrij). Check-in aan de balie = de bestaande poortvragen, dan **een kamer kiezen** en **"Verdeel bedden over de kamers"** (eigenaar 2026-09-24: "Je moet bij bellen van het dier een kamer voor het dier kiezen en daarna moet dat spel plaatsvinden op basis van hoeveel dieren je hebt op basis van welke kamers ze zitten"): "In kamer 1 slapen al 2 dieren — Boef komt erbij. Hoeveel bedden?", en de kamer krijgt precies zoveel bedden. Goed: hij springt in zijn bed. Te weinig of te veel: hij loopt erheen (de camera loopt mee), is teleurgesteld, loopt terug naar de balie en de vraag komt opnieuw.
- De slaapkamers zijn de harde gastenlimiet (sinds 2026-09-24; daarvoor de vrije bedden). Een gast mag komen zolang een slaapkamer er nog een dier bij kan hebben: een vrij bed, of vloer voor het bed dat de check-in voor hem neerzet — tot zes bedden per kamer, en alleen waar het hele bed past (in de twee basiskamers vijf bedden per kamer: tien gasten). Een gekocht bed dat er daarna nog bij past is een extra plek. Rekenen koopt beter, nooit toegang: het hotel gaat nooit op slot.
...
- **Check-in aan de balie** (was: poort) — voorraad vs dagen × nieuw, dan de kamer en de bedden voor die kamer (hierboven, §2).

Hotelwerk (nieuw):
1. **Verdeel bedden over de kamers** (was: Bedden op rij, rijen × bedden; vervangen 2026-09-24 — "Waarom zijn er 5 bedden nodig voor 1 dier?") — stap 4 van de check-in: de dieren van de gekozen kamer plus de nieuwe gast = het aantal bedden; de kamer krijgt precies dat aantal en het dier laat zien of het klopt. Geen hulp na een misser: een teleurgesteld dier en dezelfde vraag (eigenaar 2026-09-24).
...
3. **Souvenirkraam** — gast met de wens 🎁, precies betalen of wisselgeld; het gekochte (sjaaltje, hoedje, bal) blijft zichtbaar op het dier. Sinds 2026-09-24 de vierde kraam van de winkelstraat (hieronder), niet meer in de tuin.
...
6. **Wekkerdienst** — wijzers van de halklok draaien naar wekkerkaartje (hele uren → kwartieren → minuten + tijdsduur). Geen spookwijzer: na een fout geen hulp (§9, eigenaar 2026-09-24).
...
In de winkelstraat gebouwd (2026-09-24, games-d.md):
- **Hoedenkraam, Sjaalkraam, Schoenenkraam, Souvenirkraam en de Luxe winkel** (`hoeden`, `sjaals`, `schoenen`, `kraam`, `luxe`) — het dier kiest wat het koopt (pet, strohoed, strik, das, sjaals, hoedje, bal, sokjes, gympjes, laarsjes, kroon, parelketting, zonnebril, gouden slofjes); het kind rekent: precies betalen met echte munten en briefjes (groep 3–4), 4 schoentjes × de prijs (één per poot), samen met een cadeaudoosje, halve prijs, wisselgeld van €50/€100 (groep 5). Het dier draagt het daarna, klein genoeg om herkenbaar te blijven, en houdt het in zijn kast. **Een verkeerd bedrag: het dier wordt teleurgesteld de winkel uit gestuurd, sjokt langzaam weg, en het kind moet de winkel opnieuw intikken** — dezelfde vraag wacht dan (eigenaar 2026-09-24: tegen snel gokken).
- **Paskamer** (`paskamer`) — voor de spiegel kiest het kind per slot (hoofd, hals, poten, ogen) wat een dier aantrekt uit wat het al gekocht heeft. Aankleden, geen som.
...
- Arrays: **Bedden op rij** was primair; sinds 2026-09-24 is het "Verdeel bedden over de kamers" (optellen, geen rooster), dus arrays komen voortaan van de moestuin-rijtjes (de kas, zone `rijen`).
...
- **Een misser (S5, eigenaarswens 2026-09-20).** Een fout antwoord doet iets zichtbaars en kost niets (R6): het dier van de beurt is even sip (~2 s), er hangt `🔄 Nog een keer` bij, en de antwoordstrook gaat ~1,2 s op slot zodat doortikken niet tot het goede antwoord leidt — daarna komen **dezelfde vier keuzes in dezelfde volgorde** terug met leeg antwoordvakje. Geen rood, geen kruis, geen ster eraf; het spel telt zijn eigen `missers` alleen voor het adaptieve signaal. Heeft een spel geen dier van de beurt in beeld (de was, het meubelboek, de wekker: de slaper ligt in zijn eigen kamer), dan hangt het wolkje bij het ding van de kaart. (Het plan vroeg om `😢`; dat teken zit niet in de subset `fonts/Emoji.ttf` en zou tofu tekenen, dus het huispictogram voor "opnieuw" uit `voerkar`/`tobbe`.)
- **Geen hulp na een fout (eigenaarswens 2026-09-24).** "Nee geef geen hulp na fouten. Kinderen moeten zelf leren rekenen. Fout antwoord kiezen moet niet beloond worden met hulp maar juist een teleurgesteld dier of andere "bestraffing" in het spel". De hulpladder is weg uit elk spel: na een fout antwoord verschijnt **niets dat de volgende poging makkelijker maakt** — geen hulpregel of telladder op de kaart, geen spookcijfers, -munten, -wijzers of bleke aardbeien, geen oplichtende buren of strepen, geen wolkje dat zegt hoeveel er nog bij moet, dat het te ver was of welke kant op, geen recept, geen helper (buurvrouw Els) die het voordoet. Wat het kind ziet is het teleurgestelde dier (de misser hierboven) en dezelfde vraag; een spel waarin een fout antwoord wordt uitgespeeld (het dier zwemt of hinkelt wat gekozen is) laat het dier daarna teleurgesteld zijn en vraagt dan gewoon verder. De vaste zinnen die er vanaf het begin van een beurt staan (de opdracht, de vaste doe-regel) blijven en veranderen na een misser niet. Ook bij het inchecken en in "Verdeel bedden over de kamers": geen hulpregel, geen uitgeschreven antwoord, geen hint-toast, geen helper — in het beddenspel loopt het dier eerst naar de kamer (`🛏 geen bed` / `🛏 te veel bedden`) en komt het terug naar de balie. Een tik op de verkeerde plek (een krat zonder was in je hand, een sleutel ophangen vóór het getal gekozen is) krijgt nog wel een aanwijzing over de bediening: dat is geen antwoord.
