...
- [ ] omvang **M** · model **opus** · hangt af van: `B1`, `S1`, `V1`
...
- [ ] omvang **S** · model **opus** · hangt af van: `N1`
...
- [ ] omvang **M** · model **opus** · hangt af van: — · **eigenaarsbeslissing V1 nodig**
...
- [ ] omvang **M** · model **opus** · hangt af van: — · **eigenaarsbeslissing V4 nodig**
...
| batch | taken | klaar |
|---|---|---|
| **1 — Fundament** | `S1` `B1` `R1` `V1` `N1` `N2` | 0 / 6 |
| **2 — De balk staat** | `B2` `D1` `N3` `N4` `N5` `N6` `N7` `V6` | 0 / 8 |
